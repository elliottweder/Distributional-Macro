...
md"""
From the specification given to us (with the initial variables, etc.) we have the following results:

Loan amount:
* For a 1% increase in the growth rate of house price of all friends (``friends_exp_000``) there is a ``\$\beta = \$1018.37`` change in the mortgage amount. 
* For a 1% increase in the growth rate of own county house price is not statistically related to a change in the mortgage amount.

Originations:
* For a 1% increase in the growth rate of house price of all friends (``friends_exp_000``) there is a ``\beta = 0.018`` change in the mortgage count per capita 
* For a 1% increase in the growth rate of own county house price there is a ``\beta = \0.004`` change in the mortgage count per capita.

First, we find it strange that not signficant in first regression
